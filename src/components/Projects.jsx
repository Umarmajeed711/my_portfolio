        ...
        {loading
          ...
          projects?.length < 1 ?
            <div
                ...
                className="w-full col-span-4  h-40 flex justify-center items-center "
              >
                Projects Not Found
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-5 ">

           {
             projects?.map((project, i) => {
                  return (
                    <div key={i} className="col-span-1 py-2 md:py-3">
                      ...
                      <div className="relative group projects rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-theme-secondary/40 bg-theme-background">
                        ...
                        {Admin && (
                         ...
                         >
                            ...
                            <Pencil size={18} className="edit hover:!text-theme-primary"/>
                          </button>
                           <button
                            ...
                            className="edit-buttons"
                        >
                            <Trash2 size={18}  className="edit hover:!text-theme-primary"  />
